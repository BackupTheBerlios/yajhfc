...
// $Id: FtpClientProtocol.java,v 1.1 2005/09/25 10:42:12 jonas Exp $
//
 ...
 *
 * @version $Id: FtpClientProtocol.java,v 1.1 2005/09/25 10:42:12 jonas Exp $
 **/
public class FtpClientProtocol extends Object{
    ...
    * This may affect how the client and server interpret file data during
    * transfers. The default type is TYPE_ASCII per RFC 959.
    * @exception IOException io error occurred
    * @exception ServerResponseException server replied with error code

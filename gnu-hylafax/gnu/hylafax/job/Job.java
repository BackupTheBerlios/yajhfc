...
public class Job implements gnu.hylafax.Job
{
   ...
   public static String NOTIFY_REQUEUE= HylaFAXClientProtocol.NOTIFY_REQUEUE;
   public static String NOTIFY_ALL= HylaFAXClientProtocol.NOTIFY_ALL;

   public static String CHOP_DEFAULT= "default";

   public Job(HylaFAXClient c)
   ...
   public Job(HylaFAXClient c, long id)
      throws ServerResponseException,
         IOException
   {
      synchronized(c){
